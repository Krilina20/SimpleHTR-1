...
#            relu = tf.nn.relu(conv_norm)
            ...
            print ("Capa : ", i, kernelVals[i], featureVals[i], poolVals[i], pool.shape)
    ...
    def setupRNN(self):
        ...
        kernel = tf.Variable(tf.compat.v1.truncated_normal([1, 1, numHidden * 2, len(self.charList) + 1], stddev=0.1))
